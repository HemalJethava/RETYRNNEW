...
class ShareViewController: SLComposeServiceViewController {
  ...
  func storeFile(withProvider provider: NSItemProvider, _ semaphore: DispatchSemaphore) {
    provider.loadItem(forTypeIdentifier: kUTTypeData as String, options: nil) { (data, error) in
      ...
      let filePath = groupFileManagerContainer.appendingPathComponent(originalFileName)
      ...
      self.sharedItems.append([DATA_KEY: filePath.absoluteString, MIME_TYPE_KEY: mimeType, "name": originalFileName])
      semaphore.signal()
    }
  }
